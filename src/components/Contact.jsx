      ...
      <section className="min-h-screen bg-amber-200 py-16 mt-12">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {/* Address Info */}
            <div className="bg-[#071c34] text-center p-8 rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
          ...
          <div className="grid md:grid-cols-12 gap-6">
            {/* Contact Form */}
            <div className="md:col-span-8 bg-white shadow-lg rounded-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white p-4 rounded-xl flex items-start space-x-3 border border-gray-200">
                    ...
                    <textarea
                      ...
                      className="w-full h-32 outline-none text-gray-700 placeholder-gray-400 resize-none"
                    />
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="bg-[#fda40b] hover:bg-[#071c34] text-white font-semibold py-3 px-6 rounded-lg transition duration-300 transform hover:scale-105 flex items-center justify-center mx-auto space-x-2"
                  >
                    <Send className="mr-2" />
                    Send Now
                  </button>
            ...
            <div className="md:col-span-4">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7058.264313616767!2d75.8725797749791!3d22.71754937967809!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39629b23a0eafb8b%3A0x921c7a95cf263759!2sRPL%20Maheshwari%20College!5e0!3m2!1sen!2sin!4v1686765440279!5m2!1sen!2sin"
                  title="Location"
                  allowFullScreen
                ></iframe>
              </div>
