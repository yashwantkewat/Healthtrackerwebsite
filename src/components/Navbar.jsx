...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-500 text-white fixed top-0 left-0 w-full z-50 shadow-lg">
      ...
      <div
        style={{
          position: 'absolute',
          top: `${cursorPos.y - 50}px`,  // Adjust position to follow the cursor
          left: `${cursorPos.x - 50}px`, // Adjust position to follow the cursor
          width: '100px',
          height: '100px',
          borderRadius: '50%',
